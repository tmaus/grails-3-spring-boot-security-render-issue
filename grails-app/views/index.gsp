...
<html>
    ...
    <body>
        ...
        <div id="page-body" role="main">
            <h1>Grails 3.0.4 - Spring Boot Security - Render tag issue</h1>
            <p>
                <ul>
            <li>Click on 'PublicController first </li>
            <li>Click now on 'PrivateController', login with any credentials </li>
        </ul>
